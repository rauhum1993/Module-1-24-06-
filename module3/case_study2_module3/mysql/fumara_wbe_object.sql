...
insert into furama_wbe.service(service_id,service_name,service_area,service_cost,service_max_people,rent_type_id,
	...
	insert into furama_wbe.position (position_id,position_name)
		values 	('1','Giám đốc'),
				('2','Quản lý'),
				('3','Giám Sát'),
				('4','Chuyên Viên'),
				('5','Phục Vụ'),
				('6','Lễ Tân');
insert into furama_wbe.education_degree (education_degree_id,education_degree_name) 
			values 	('1','Sau Đại Học'),
					('2','Đại Học'),
					('3','Cao Đẳng'),
					('4','Trung Cấp');
insert into furama_wbe.division (division_id,division_name)    
					values 	('1','Quản Lý'),
							('2','Phục Vụ'),
							('3','Hành Chính'),
							('4','Sale-Marketing');
  insert into furama_wbe.role (role_id,role_name)    
					values 	('1','Thánh Nổ'),
							('2','Chúa Hề'),
							('3','Fan Sky'),
							('4','Học trò thầy Huấn');    
    insert into furama_wbe.user (username,password)    
    ...
    insert into furama_wbe.employee (employee_id,employee_name,employee_birthday,employee_salary,employee_id_card,employee_phone,
      ...
      insert into   furama_wbe.attach_service (attach_service_id,attach_service_name,attach_service_cost,attach_service_unit,attach_service_status)     
